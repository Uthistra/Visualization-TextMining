...
#2.7 countrywise plot

#create a map-shaped window
mapDevice('x11')
#join to a coarse resolution map
spdf <- joinCountryData2Map(All_counts, joinCode="NAME", nameJoinColumn="Country")
mapCountryData(spdf, nameColumnToPlot="sentiment", catMethod="fixedWidth")
...
CountDataset <-as.data.frame(na.omit(CountDataset))
...
write.csv(word_pairs_Corelation,"wordpaircorelation.csv") # save the corelated excel in a csv file

#Created by - Uthistra K